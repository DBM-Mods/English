...
<br>
	...
	<div style="padding-top:12px">
		...
		<td style="width:33% !important">
		<span class="dbminputlabel">Correction X</span><br>
			<input id="x2" class="round" type="text" value="0">
		</td>

		<td style="width:33% !important">
		<span class="dbminputlabel">Correction Y</span><br>
	...
	<tab label="Border" icon="block layout">
	<div style="padding-top:12px">
...
<div id="bordadoxinxyla" style="padding-top:15px">
	...
	<tab label="Shadow" icon="cloud">
		<div style="padding-top:12px">
		<span class="dbminputlabel">Shadow Type</span><br>
	...
	<span class="dbminputlabel">Shadow smudge</span><br>
	...
	<tab label="Definitions" icon="cogs">
		...
		<table style="width:100%"><tr>
		<td style="width:48%">
		<span class="dbminputlabel">Text Font (Local/URL)</span><br>
...
<span class="dbminputlabel">Width Type</span>
<div style="width:100%;background:rgba(50,50,50,0.5);-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px;padding:8px 4px">
...
<option value="3">Maximum width without word wrap</option>
</select>
