module.exports = {
	...
	<div id="FirstNum">
	<span class="dbminputlabel">Value 1</span><br>
	...
	<div id="SecondNum">
	<span class="dbminputlabel">Value 2</span><br>
	...
	init: function() {
		...
		glob.onChange1 = function(event) {
			...
			if (value == 0) {
				...
				document.querySelector("[name='Informativo']").innerText = (`Sum two values\nExample: 5 + 5 = 10`);
			} else if (value == 1) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				document.querySelector("[name='Meio']").innerText = (`-`);
				document.querySelector("[name='Informativo']").innerText = (`Subtracts two values\nExample: 5 - 2 = 3`);
			} else if (value == 2) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				document.querySelector("[name='Meio']").innerText = (`x`);
				document.querySelector("[name='Informativo']").innerText = (`Multiplies two values\nExample: 5 x 5 = 25`);
			} else if (value == 3) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				document.querySelector("[name='Meio']").innerText = (`÷`);
				document.querySelector("[name='Informativo']").innerText = (`Divides two values\nExample: 10 ÷ 2 = 5`);
			} else if (value == 4) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Round to the nearest whole number, round up or down\nExamples:\n105.23 = 105\n105.50 = 106\n105.72 = 106`);
			} else if (value == 5) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				document.querySelector("[name='Meio']").innerText = (`AAS`);
				document.querySelector("[name='Informativo']").innerText = (`Rounds to a whole number by specifying the number of significant figures.\nExamples:\n105.5055465 AAS 3 = 106\n105.5055465 AAS 4 = 105.5\n105.5055465 AAS 6 = 105.506`);
			} else if (value == 6) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Absolute number \nExample\n105 = 105\n-105 = 105`);
			} else if (value == 7) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Round up\nExamples:\n105.43 = 106\n105.01 = 106`);
			} else if (value == 8) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Round down\nExamples:\n105.99 = 105\n105.01 = 105`);
			} else if (value == 9) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Calculates the factorial of (Value 1)\nExamples:\n[ 3 ] 3×2×1= 6\n[ 4 ] 4×3×2×1 = 24\n[ 5 ] 5×4×3×2×1 = 120`);
			} else if (value == 10) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				document.querySelector("[name='Meio']").innerText = (`X , Y`);
				document.querySelector("[name='Informativo']").innerText = (`Returns the value of x raised to y\nExemplos:\nx = 2, y = 3 | Result: 8`);
			} else if (value == 11) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				...
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Returns the sine of (Value 1) in radians`);
			} else if (value == 13) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Returns the cosine of (Value 1) in radians`);
			} else if (value == 14) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Returns the tangent of the angle (Value 1)`);
			} else if (value == 15) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Returns the arc sine of (Value 1)`);
			} else if (value == 16) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Returns the arc cosine of (Value 1)`);
			} else if (value == 17) {
				dom.style.display = "none";
				dom2.style.display = null;
				dom2p.style.width = "100%";
				document.querySelector("[name='Meio']").innerText = (``);
				document.querySelector("[name='Informativo']").innerText = (`Returns the arc tangent of (Value 1) as a numerical value between PI/2 and PI/2 radian`);
			} else if (value == 18) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				document.querySelector("[name='Meio']").innerText = (`% de`);
				document.querySelector("[name='Informativo']").innerText = (`Calculates in percentages\nExamples:\n25 % of 500 = 125`);
			} else if (value == 19) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				...
				document.querySelector("[name='Meio']").innerText = (`√`);
				document.querySelector("[name='Informativo']").innerText = (`Square root of (Value 1)`);
			} else if (value == 24) {
				dom.style.display = null;
				dom2.style.display = null;
				dom2p.style.width = "45%";
				document.querySelector("[name='Meio']").innerText = (`e`);
				document.querySelector("[name='Informativo']").innerText = (`Random number between (Value 1) and (Value 2)`);
			} else {
				dom.style.display = 'none';
			}
