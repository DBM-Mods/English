module.exports = {
  ...
  subtitle(data, presets) {
    const info = [
      ...
      "Server Bot Count",
      "Server Channel ID List",
      "Server Role ID List",
      "Server Member ID List",
      "",
      "Server Human Count",
      "",
      "Server Role Count",
      ...
      "Server Boost Count",
      "Server Upgrade Level",
      "Server Banner URL",
      "Server Resource List",
      "Server Owner ID",
      "Server Custom URL Code",
      "Server Widget Channel ID",
      "Server AFK channel ID",
      "Server Premium Progress Bar Enabled",
      "Server Description",
      "Server In Partnership",
      ...
      "Total members on voice channels",
      "List of members by ID present in voice channels",
      "List of members present in voice channels",
    ];
...
<div>
	<div style="padding-top: 8px; width: 100%;">
      ...
      <option value="21">Big Server</options>
      ...
      <option value="45">Server Upgrade Level</options>
      </optgroup>
      ...
      <option value="37">Server Role Count</options>
      ...
      <option value="61">Server Timestampr</options>
      <option value="18">Server Created at</options>
      <option value="22">Server Connected to</options>
      </optgroup>
      ...
      <option value="33">Server Member ID List</options>
      <option value="13">Server Channel List</options>
      <option value="31">Server Channel ID List</options>
      <option value="16">Server Emoji List</options>
      <option value="14">Server Role List</options>
      <option value="32">Server Role ID List</options>
      <option value="41">Server Banned List</options>
      <option value="42">Server Invite List</options>
      <option value="71">List of members by ID present in voice channels</options>
      <option value="72">List of members present in voice channels</options>
      </optgroup>
