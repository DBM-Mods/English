...
<div style="margin: 0; overflow-y: none;">
    <div style="width: 100%;">
        <div style="float: left; width: 38%;">
              <span class="dbminputlabel">Variable</span><br>
        ...
        <div id="pathContainer" style="padding-top: 8px;">
            <span class="dbminputlabel">JSON Path: (supports the usage of <a href="http://goessner.net/articles/JsonPath/index.html#e2" target="_blank">JSON Path (Regex)</a>)</span><br>
    ...
    <div style="width: 100%;">
        <div style="float: left; width: 38%;">
            <label for="storage">
                <font color="white"><span class="dbminputlabel">Store in:</span></font>
            </label>
        ...
        <div id="varNameContainer" style="margin-left: 10px; float: left; width: 59%;">
            <label for="varName">
                <font color="white"><span class="dbminputlabel">Variable name</span></font>
            </label>
    ...
    <div style="width:100%">
        <div style="float: left;width: 48%">
            <br>
            <label for="behavior">
                <font color="white"><span class="dbminputlabel">Continue sequence of actions</span></font>
            </label>
        ...
        <div style="float: left; margin-left: 10px; width: 48%;">
            <br>
            <label for="debugMode">
                <font color="white"><span class="dbminputlabel">Debug mode</span></font>
            </label>
