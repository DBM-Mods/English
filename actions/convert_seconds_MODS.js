module.exports = {
	...
	html: function(isEvent, data) {
		return `
		<div style="position:absolute;bottom:0px;border: 1px solid #222;background:#000;color:#999;padding:3px;right:0px;z-index:999999">Version 0.6</div>
		<div style="position:absolute;bottom:0px;border: 1px solid #222;background:#000;color:#999;padding:3px;left:0px;z-index:999999">dbmmods.com</div>
		<div style="float: left; width: 100%;">
		<span class="dbminputlabel">Convert seconds</span>
			<input id="time" class="round" type="text">
		</div><br><br><br>
		
		<div style="width: 100%;">
			<span class="dbminputlabel">Date type</span><br>
			<select id="tipo" class="round" onchange="glob.onComparisonChanged(this)">
	
				<option value="0" selected>Ignore groups equal to 0</option>
				<option value="10">Ignore groups equal to 0 and ignore groups [years/months]</option>
				<option value="11">Ignore groups equal to 0 and ignore groups [years/months/days]</option>
	
				<option value="5">[Minimum 2 digits] Ignore groups equal to 0</option>
				<option value="6">[Minimum 2 digits] Ignore groups equal to 0 and ignore groups [years/months]</option>
				<option value="7">[Minimum 2 digits] Ignore groups equal to 0 and ignore groups [years/months/days]</option>
	
				<option value="1">Show all groups</option>
				<option value="8">Show only groups [days/hours/minutes/seconds]</option>
				<option value="9">Show only groups [hours/minutes/seconds]</option>
	
				<option value="2">[Minimum 2 digits] Show all groups</option>
				<option value="3">[Minimum 2 digits] Show only groups [days/hours/minutes/seconds]</option>
				<option value="4">[Minimum 2 digits] Show only groups [hours/minutes/seconds]</option>
			</select>
		</div>
		<br>
	
		<center><span class="dbminputlabel">Date Texts</span></center>
		<div style="width:100%;border:1px solid #333;background: rgba(50,50,50,0.5)"><br>
	<table style="width:100%"><tr>
	<td><span class="dbminputlabel">Years</span><input id="ano" value=" years " class="round" type="text"></td>
	<td><span class="dbminputlabel">Months</span><input id="meses" value=" months " class="round" type="text"></td>
	<td><span class="dbminputlabel">Days</span><input id="dia" value=" days " class="round" type="text"></td>
	<td><span class="dbminputlabel">Hours</span><input id="hora" value=" hours " class="round" type="text"></td>
	<td><span class="dbminputlabel">Minutes</span><input id="min" value=" minutes " class="round" type="text"></td>
	<td><span class="dbminputlabel">Seconds</span><input id="seg" value=" seconds " class="round" type="text"></td></tr>
	</table>
	<br>
	<table style="width:100%"><tr>
	<td><span class="dbminputlabel">Year</span><input id="ano2" value=" year " class="round" type="text"></td>
	<td><span class="dbminputlabel">Month</span><input id="meses2" value=" month " class="round" type="text"></td>
	<td><span class="dbminputlabel">Day</span><input id="dia2" value=" day " class="round" type="text"></td>
	<td><span class="dbminputlabel">Hour</span><input id="hora2" value=" hour " class="round" type="text"></td>
	<td><span class="dbminputlabel">Minute</span><input id="min2" value=" minute " class="round" type="text"></td>
	<td><span class="dbminputlabel">Second</span><input id="seg2" value=" second " class="round" type="text"></td>
	</tr></table>
