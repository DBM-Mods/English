module.exports = {
  ...
  html (isEvent, data) {
    ...
    <div>
  <span class="dbminputlabel">To draw</span><span style="float:right"><button class="tiny compact ui icon button" onclick="(function(){document.getElementById('xinxylainfo').style.display = 'block';})()">Information</button></span><br>
...
<div style="width:100%;background:#333;padding:10px"><span style="float:right"><button class="tiny compact ui icon button" onclick="(function(){document.getElementById('xinxylainfo').style.display = 'none';})()">Close [X]</button></span>
<b>Information</b></div>
<div style="padding:10px">
For the canvas context use <span class="xin">ctx.</span> or <span class="xin">context.</span><br><br>
To collect image width use <span class="xin">width</span> or <span class="xin">largura</span><br><br>
To collect the image height use <span class="xin">height</span> or <span class="xin">altura</span><br><br>
...
For tutorials on how to draw using canvas <a style="cursor:pointer" class="xinxylalink" data-url="https://www.html5canvastutorials.com/tutorials/html5-canvas-linear-gradients">Click here </a>
</div>
</div>
