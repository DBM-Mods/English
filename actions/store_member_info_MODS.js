...
<div style="padding-top: 8px;">
  ...
  <option value="15">Member State</option>
  ...
  <option value="6">Member's Last Message (Removed)</option>
  <option value="26">Last Message Id (Removed)</option>
  ...
  <option value="11">Is the member mute?</option>
  <option value="12">Is the member deaf?</option>
  <option value="13">Is the member banable?</option>
  <option value="14">Member's Game Status Name</option>
