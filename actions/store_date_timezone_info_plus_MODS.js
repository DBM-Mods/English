module.exports = {
    ...
    subtitle: function(data) {
        const info = ['Day of the week', 'Day (number)', 'Day of the year', 'Week of the year', 'Month of the year', 'Month (number)', 'Year', 'Hour', 'Minutes', 'Seconds', 'Milliseconds', 'Timezone', 'Unix Timestamp', 'Data completa']
    ...
    <div style="position:absolute;bottom:0px;border: 1px solid #222;background:#000;color:#999;padding:3px;left:0px;z-index:999999">dbmmods.com</div>
        ...
        <span class="dbminputlabel">Source date</span><br>
            <input id="sourceDate" class="round" type="text" placeholder="Ex: Sun Oct 26 2019 10:38:01 GMT+0200 or \${new Date}">
        </div>
